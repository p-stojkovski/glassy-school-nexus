...
const AttendanceManagement: React.FC = () => {
  ...
  const [selectedClassId, setSelectedClassId] = useState<string>('all-classes');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {activeTab === 'mark' ? (
          <AttendanceMarker classId={selectedClassId} date={selectedDate} />
        ) : (
          <AttendanceHistory classId={selectedClassId} date={selectedDate} />
        )}
      </div>
    </div>
  );
