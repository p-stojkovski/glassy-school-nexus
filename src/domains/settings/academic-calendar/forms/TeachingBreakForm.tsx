...
import type { TeachingBreak } from '../../types/academicCalendarTypes';
import { breakTypeLabels } from '../../types/academicCalendarTypes';
import {
  teachingBreakFormSchema,
  type TeachingBreakFormData,
} from '../schemas/academicCalendarSchemas';
...
export const TeachingBreakForm: React.FC<TeachingBreakFormProps> = ({
  teachingBreak,
  academicYearId,
  onSubmit,
  onCancel,
