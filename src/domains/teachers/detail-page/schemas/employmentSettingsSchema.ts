...
export const employmentSettingsSchema = z
  .object({
    ...
    baseNetSalary: z.coerce
      ...
      .max(BASE_SALARY_VALIDATION.MAX, `Base salary cannot exceed ${BASE_SALARY_VALIDATION.MAX.toLocaleString()} MKD`)
      .optional(),
  })
  .refine(
    (data) => data.employmentType !== 'full_time' || (data.baseNetSalary && data.baseNetSalary > 0),
    {
...
export type EmploymentSettingsFormData = z.infer<typeof employmentSettingsSchema>;
