...
export default function SalarySetupSheet({
  ...
  const confirmText = isSubmitting
    ? 'Saving...'
    : breakdown
      ? `Save (${formatMKD(breakdown.grossSalary)} gross)`
      : 'Save Configuration';
  ...
  return (
    <FormSheet
      ...
      size="xl"
      icon={DollarSign}
      title="Set Up Teacher Salary"
      description="Configure the monthly gross salary for this teacher. You can enter the desired net amount and we'll calculate the required gross, or enter the gross directly."
