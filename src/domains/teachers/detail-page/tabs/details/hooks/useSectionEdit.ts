...
/**
 * Section types for the Teacher Details tab
 */
export type SectionType = 'personal' | 'bio';
...
/**
 * useSectionEdit - Manages single-section editing state for Teacher Details Tab
 *
