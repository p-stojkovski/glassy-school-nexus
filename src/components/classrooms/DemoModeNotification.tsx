...
const DemoModeNotification: React.FC<DemoModeNotificationProps> = ({ onResetDemo }) => {
  return (
    <Alert className="bg-blue-900/30 text-blue-100 border-blue-700 mb-6">
      <AlertTriangle className="h-4 w-4 mr-2" />
      <AlertDescription className="flex items-center justify-between w-full">
        <span>
          <strong>Demo Mode:</strong> This is a demo of the Classroom Management System. All data is saved locally in your browser
