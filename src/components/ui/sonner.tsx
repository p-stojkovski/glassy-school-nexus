    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          title: "group-[.toast]:text-white group-[.toast]:font-medium group-[.toast]:text-base",
          closeButton: "group-[.toast]:text-white/60 group-[.toast]:hover:text-white group-[.toast]:transition-colors",
          // Custom styles for different toast types
          success: "border-green-500/30 from-green-500/20 to-green-500/10 shadow-green-500/5",
          error: "border-red-500/30 from-red-500/20 to-red-500/10 shadow-red-500/5",
          warning: "border-yellow-500/30 from-yellow-500/20 to-yellow-500/10 shadow-yellow-500/5",
          info: "border-blue-500/30 from-blue-500/20 to-blue-500/10 shadow-blue-500/5",
          // Add loading animation
          loading: "border-purple-500/30 from-purple-500/20 to-purple-500/10 shadow-purple-500/5",
        },
      }}
      {...props}
    />
